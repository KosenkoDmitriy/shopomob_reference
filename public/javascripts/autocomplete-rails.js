...
//        }
        ...
        jQuery(e).bind( "keydown", function( event ) {
            console.log("keydown");
...
//                        availableTags, extractLast( request.term ) ) );
                    ...
                    term: extractLast( request.term )
                                    ...
                                    console.log("arguments.count="+arguments.length+"|"+arguments[0].length);
...
//            console.log("remember_string: " + this.value);
//
//            jQuery(this).bind("keyup.clearId", function () {
//                console.log("bind.clearId" );
//
